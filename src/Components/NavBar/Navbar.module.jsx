...
import NavbarFloat from "./NavbarDropDown.module";
...
const NavBar = () => {
  ...
  const search = () => {
    const config = {
      method: "get",
      url: `https://meesho-all.herokuapp.com/ethnicwear`,
    };
    ...
    <>
      <div className={styles.Main_Header}>
        ...
        <div className={styles.links}>
          ...
          <Link onClick={() => getQ("Dresses")} to="/ethic">
            Womens Ethic
          </Link>
          <NavbarFloat
            key="women ethic"
          ...
          />
          <Link onClick={() => getQ("Dresses")} to="/western">
            Womens Western
          </Link>
          <NavbarFloat
            key="women western"
          ...
          />
          <Link onClick={() => getQ("Jewellery")} to="/jewellery">
          ...
          <Link onClick={() => getQ("Mens Top Were")} to="/men">
            Men
          </Link>
          <NavbarFloat
            key="Mens Top "
          ...
          <Link onClick={() => getQ("Beauty and health")} to="/beauty">
            Beauty & Health
          </Link>
          <NavbarFloat
            key="Beauty n"
            onClick={() => {
              getQ("Beauty and health");
              history.push("/beauty");
            }}
            textArr={[
          ...
          <Link onClick={() => getQ("Bags and Footwear")} to="/bag">
            Bags and Footwear
          </Link>
          <NavbarFloat
            key="Bags and"
            onClick={() => {
              getQ("Bags and Footwear");
              history.push("/bag");
            }}
            textArr={[
          ...
          />
          <Link onClick={() => getQ("Home and Kitchen")} to="/kitchen">
            Home & Kitchen
          </Link>
          <NavbarFloat
            key="Home and kitchen"
            onClick={() => {
              getQ("Home and Kitchen");
          ...
          />
          <Link onClick={() => getQ("kids")} to="/kids">
            Kids
          </Link>
          <NavbarFloat
            key="kids"
          ...
          <Link onClick={() => getQ("electronics")} to="/electronics">
            Electronics
          </Link>
          <NavbarFloat
            key="Home"
