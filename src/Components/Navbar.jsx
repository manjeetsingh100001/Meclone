    ...
    return (
        <>
            <div className={styles.Main_Header}>
                ...
                <Link onClick={() => getQ("ethnicwear")} to="/category">
            Womens Ethic
          </Link>
          <NavbarFloat
            key="women ethic"
          ...
          />
          <Link onClick={() => getQ("westenware")} to="/category">
            Womens Western
          </Link>
          <NavbarFloat
            key="women western"
          ...
          />
          <Link onClick={() => getQ("jewellery")} to="/category">
          ...
          <Link onClick={() => getQ("men")} to="/category">
            Men
          </Link>
          <NavbarFloat
            key="Mens Top "
          ...
          <Link onClick={() => getQ("beauty")} to="/category">
            Beauty & Health
          </Link>
          <NavbarFloat
            key="Beauty n"
          ...
          <Link onClick={() => getQ("footware")} to="/category">
            Bags and Footwear
          </Link>
          <NavbarFloat
            key="Bags and"
          ...
          />
          <Link onClick={() => getQ("home")} to="/category">
            Home & Kitchen
          </Link>
          <NavbarFloat
          ...
          />
          <Link onClick={() => getQ("kids")} to="/category">
            Kids
          </Link>
          <NavbarFloat
            key="kids"
          ...
          <Link onClick={() => getQ("electronics")} to="/category">
            Electronics
          </Link>
          <NavbarFloat
            key="Home"
